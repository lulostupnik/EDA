...
public class ExpTree implements ExpressionService {
	...
	static private Map<String, String> vars = new HashMap<>();
	...
	public ExpTree(Map<String, String> vars) {
		this();
		hasVars = true;
		this.vars = vars;
	}
	...
	static final class Node {
		...
		private void buildExpression() {
			if(lineScanner.hasNext("\\(")) {
				...
				String aux;
				aux = lineScanner.next();
				if(vars.get(aux) != null){
					data = vars.get(aux);
					left = null;
					right = null;
				}
...
}  // end BinaryTree.BinaryTree.ExpTree class