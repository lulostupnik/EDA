package ar.itba.edu.BinaryTree_;
...
public class BinaryTree<T> implements BinaryTreeService<T> {
    ...
    public void toFile(String name) throws IOException {
        //String path = "/Users/lulos/Desktop/EDA/Segundo Parcial/src/main/java/ar/itba/edu/Trees/resources/" + name;
        String path = "C:\\Users\\lulos\\Desktop\\EDA\\Segundo Parcial\\src\\main\\java\\ar\\itba\\edu\\Trees\\src\\main\\resources\\" + name;
...
//Por alguna razon falla la vez que se crea el archivo, y despues anda.
    public static void main(String[] args) throws IOException, InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
        ...
        BinaryTree<String> bt = new BinaryTree<>("BinaryTree_/data0_1", String.class);
        bt.printHierarchy();


        System.out.println("---------------------------");

        BinaryTree rta = new BinaryTree("BinaryTree_/data1", String.class);
        rta.printHierarchy();
        rta.toFile("BinaryTree_/result");
        System.out.println(rta.getHeight());

        BinaryTree original = new BinaryTree("BinaryTree_/data0_3", String.class);
        original.toFile("BinaryTree_/mydata0_3");

        BinaryTree copia = new BinaryTree("BinaryTree_/mydata0_3", String.class);
        ...
        BinaryTree otro = new BinaryTree("BinaryTree_/data0_1", String.class);
