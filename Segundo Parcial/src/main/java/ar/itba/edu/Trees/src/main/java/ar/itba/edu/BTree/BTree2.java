...
public class BTree2<T extends Comparable<T>> implements ITree<T> {
...
//            }
    ...
    public static class JavaCompatibleBTree2<T extends Comparable<T>> extends java.util.AbstractCollection<T> {
        ...
        private BTree2<T> tree = null;

        public JavaCompatibleBTree2(BTree2<T> tree) {
            this.tree = tree;
        }
        ...
        private static class BTree2Iterator<C extends Comparable<C>> implements java.util.Iterator<C> {
            ...
            private BTree2<C> tree = null;
            private BTree2.Node<C> lastNode = null;
            private C lastValue = null;
            private int index = 0;
            private Deque<BTree2.Node<C>> toVisit = new ArrayDeque<BTree2.Node<C>>();

            protected BTree2Iterator(BTree2<C> tree) {
                this.tree = tree;
