...
//region Otros Inserts
	...
	public Iterator<T> iterator() {
		return new SortedLinkedListIteratorByLuchitoAndDevesa();
	}
	...
	private class SortedLinkedListIterator implements Iterator<T> {
		...
		private class SortedLinkedListIteratorByLuchitoAndDevesa implements Iterator<T> {
			private Node current = root;
	...
	private class SortedLinkedListIterator2 implements Iterator<T> {
		private Node current = root;
